...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden pt-20" style={{ background: 'radial-gradient(ellipse 120% 60% at 50% 0%, rgba(16,185,129,0.13) 0%, transparent 55%), radial-gradient(ellipse 80% 50% at 80% 80%, rgba(16,185,129,0.08) 0%, transparent 60%), #e8f0eb' }}>
      <style jsx global>{`
      ...
      <section className="relative z-30 flex h-[85vh] items-center justify-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-200/50 via-emerald-100/30 to-stone-100/80 overflow-hidden text-center shadow-[0_20px_50px_rgba(0,0,0,0.06)] border-b border-emerald-200/40">
        {/* 에메랄드 베이스 넓고 맑은 글로우 */}
      ...
      <section className="pt-56 pb-32 px-8 w-full text-left relative overflow-hidden" style={{ background: 'transparent' }}>
        ...
        <div className="absolute top-0 left-0 w-full h-[500px] bg-gradient-to-b from-stone-100/50 to-transparent pointer-events-none z-0"></div>
        {/* 에메랄드 혼합 글로우 — 투명도 강화 */}
        ...
        <div className="mx-auto max-w-[1200px] relative z-10">
          ...
          <p className="text-slate-600 font-bold mb-16">핵심적인 네 가지 전도표제를 소개합니다.</p>

...
const missionData = [
  ...
  { id: '03', title: '사중복음윤리 실천', desc: '사중복음신앙 고백과 사중복음정신을 살려 모든 그리스도인들이 가정과 교회와 사회생활 가운데 하나님의 뜻대로 살도록 돕습니다.', items: [{ highlight: '생명의 윤리 실천으로!', text: '생명의 우선성에 기초한 생활' }, { highlight: '사랑의 윤리 실천으로!', text: '이웃의 아픔에 동참하는 생활' }, { highlight: '회복의 윤리 실천으로!', text: '분리의 재결합을 추구하는 생활' }, { highlight: '공의의 윤리 실천으로!', text: '주어진 힘을 바르게 사용하는 생활' }] }
];

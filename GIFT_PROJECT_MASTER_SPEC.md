...
- [x] **소셜 로그인 UI**: 구글/카카오 로그인 버튼 추가 (UI 레벨)
...
- [ ] **소셜 로그인 실제 연동**: 구글/카카오 OAuth 앱 등록 및 Supabase provider 활성화

#### P2 (다음 단계)
- [ ] **자료실 UI 추가 고도화**: 현재 에디토리얼 리스트 → 검색 기능 추가
- [ ] **활동 갤러리 고도화**: 관리자 갤러리 업로드 기능 완성도 향상
- [ ] **연락처 페이지**: `/contact` 실질 내용 구현
...
*최종 업데이트: 2026-03-17 | 배포 브랜치: main | 호스팅: Vercel*
